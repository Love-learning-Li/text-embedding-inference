...
<div style="background: rgba(255, 255, 255, 0.05); border-radius: 10px; padding: 15px; text-align: center; display: flex; flex-direction: column; justify-content: center; min-height: 150px;"><div style="color: #48bb78; font-size: 24px; font-weight: bold;">+69.9%</div><div style="color: #a0aec0; font-size: 12px; margin-top: 5px;">QPS提升</div></div>
<div style="background: rgba(255, 255, 255, 0.05); border-radius: 10px; padding: 15px; text-align: center; display: flex; flex-direction: column; justify-content: center; min-height: 150px;"><div style="color: #48bb78; font-size: 24px; font-weight: bold;">5个</div><div style="color: #a0aec0; font-size: 12px; margin-top: 5px;">融合算子替换</div></div>
<div style="background: rgba(255, 255, 255, 0.05); border-radius: 10px; padding: 15px; text-align: center; display: flex; flex-direction: column; justify-content: center; min-height: 150px;"><div style="color: #48bb78; font-size: 24px; font-weight: bold;">-41%</div><div style="color: #a0aec0; font-size: 12px; margin-top: 5px;">总处理时间</div></div>
<div style="background: rgba(255, 255, 255, 0.05); border-radius: 10px; padding: 15px; text-align: center;"><div style="color: #4fd1c5; font-size: 13px; font-weight: bold; margin-bottom: 10px;">测试条件</div><div style="display: flex; flex-direction: column; gap: 8px;"><div style="background: rgba(72, 187, 120, 0.12); border: 1px solid rgba(72, 187, 120, 0.35); border-radius: 8px; padding: 8px 10px; color: #e2e8f0; font-size: 11px; line-height: 1.4;"><span style="color: #68d391; font-weight: bold;">batch_size</span><span style="color: #a0aec0;"> = </span><span style="color: #ffffff; font-weight: bold;">20</span></div><div style="background: rgba(72, 187, 120, 0.12); border: 1px solid rgba(72, 187, 120, 0.35); border-radius: 8px; padding: 8px 10px; color: #e2e8f0; font-size: 11px; line-height: 1.4;"><span style="color: #68d391; font-weight: bold;">num_threads</span><span style="color: #a0aec0;"> = </span><span style="color: #ffffff; font-weight: bold;">4</span></div><div style="background: rgba(72, 187, 120, 0.12); border: 1px solid rgba(72, 187, 120, 0.35); border-radius: 8px; padding: 8px 10px; color: #e2e8f0; font-size: 11px; line-height: 1.4;"><span style="color: #68d391; font-weight: bold;">total_count_text</span><span style="color: #a0aec0;"> = </span><span style="color: #ffffff; font-weight: bold;">1024</span></div></div></div>
</div>
</div>
...
<div style="margin: 20px 0; padding: 24px; background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%); border-radius: 18px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
<div style="color: #e2e8f0; font-size: 16px; font-weight: bold; text-align: center; margin-bottom: 20px;">调用链对比：路径长短决定 dispatch 开销</div>

<div style="background: rgba(248, 113, 113, 0.08); border: 1px solid rgba(248, 113, 113, 0.22); border-radius: 14px; padding: 16px; margin-bottom: 16px;">
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
<div style="color: #fca5a5; font-size: 14px; font-weight: bold;">nn.Linear 调用链</div>
<div style="color: #fca5a5; font-size: 12px;">多层 Python/C++ dispatch</div>
</div>
<div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; justify-content: center;">
<span style="background: linear-gradient(135deg, #fb7185 0%, #e11d48 100%); color: white; padding: 8px 12px; border-radius: 999px; font-size: 12px; font-weight: bold;">Python forward()</span>
<span style="color: #fda4af; font-size: 16px;">→</span>
<span style="background: rgba(255,255,255,0.08); color: #f8fafc; padding: 8px 12px; border-radius: 999px; font-size: 12px;">F.linear()</span>
<span style="color: #fda4af; font-size: 16px;">→</span>
<span style="background: rgba(255,255,255,0.08); color: #f8fafc; padding: 8px 12px; border-radius: 999px; font-size: 12px;">aten::linear</span>
<span style="color: #fda4af; font-size: 16px;">→</span>
<span style="background: rgba(255,255,255,0.08); color: #f8fafc; padding: 8px 12px; border-radius: 999px; font-size: 12px;">aten::t</span>
<span style="color: #fda4af; font-size: 16px;">→</span>
<span style="background: rgba(255,255,255,0.08); color: #f8fafc; padding: 8px 12px; border-radius: 999px; font-size: 12px;">aten::addmm</span>
<span style="color: #fda4af; font-size: 16px;">→</span>
<span style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; padding: 8px 12px; border-radius: 999px; font-size: 12px; font-weight: bold;">aclnnAddmm</span>
</div>
</div>

<div style="background: rgba(74, 222, 128, 0.08); border: 1px solid rgba(74, 222, 128, 0.22); border-radius: 14px; padding: 16px;">
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
<div style="color: #86efac; font-size: 14px; font-weight: bold;">npu_linear 调用链</div>
<div style="color: #86efac; font-size: 12px;">更短路径，直接下发</div>
</div>
<div style="display: flex; align-items: center; gap: 8px; flex-wrap: wrap; justify-content: center;">
<span style="background: linear-gradient(135deg, #4ade80 0%, #16a34a 100%); color: white; padding: 8px 12px; border-radius: 999px; font-size: 12px; font-weight: bold;">torch_npu.npu_linear()</span>
<span style="color: #86efac; font-size: 16px;">→</span>
<span style="background: rgba(255,255,255,0.08); color: #f8fafc; padding: 8px 12px; border-radius: 999px; font-size: 12px;">npu::npu_linear</span>
<span style="color: #86efac; font-size: 16px;">→</span>
<span style="background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white; padding: 8px 12px; border-radius: 999px; font-size: 12px; font-weight: bold;">aclnnAddmm</span>
</div>
</div>

<div style="margin-top: 16px; color: #cbd5e1; font-size: 12px; text-align: center;">两者最终都落到同一个底层算子，但 <span style="color: #fca5a5; font-weight: bold;">nn.Linear</span> 路径更长，<span style="color: #86efac; font-weight: bold;">npu_linear</span> 路径更短，因此前者更容易累积 dispatch 开销。</div>
</div>
...
<div style="display: flex; margin-bottom: 8px; align-items: center;"><span style="width: 60px; color: #a0aec0; font-size: 12px;">NPU</span><span style="flex: 1; height: 24px; background: rgba(255, 255, 255, 0.1); border-radius: 4px; position: relative; overflow: hidden;"><span style="height: 100%; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: white; font-weight: bold; width: 15%; background: linear-gradient(90deg, #4299e1 0%, #3182ce 100%);">kernel</span><span style="height: 100%; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: #718096; font-weight: bold; width: 85%; position: absolute; left: 15%; background: rgba(255, 255, 255, 0.1);">等待CPU...</span></span></div>
<div style="display: flex; margin-bottom: 8px; align-items: center;"><span style="width: 60px; color: #a0aec0; font-size: 12px;">npu_linear</span><span style="flex: 1; height: 24px; background: rgba(255, 255, 255, 0.1); border-radius: 4px; position: relative; overflow: hidden;"><span style="height: 100%; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: white; font-weight: bold; width: 20%; background: linear-gradient(90deg, #48bb78 0%, #38a169 100%);">dispatch</span></span></div>
...
<div style="display: flex; margin-bottom: 8px; align-items: center;"><span style="width: 60px; color: #a0aec0; font-size: 12px;">NPU</span><span style="flex: 1; height: 24px; background: rgba(255, 255, 255, 0.1); border-radius: 4px; position: relative; overflow: hidden;"><span style="height: 100%; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 10px; color: white; font-weight: bold; width: 98%; background: linear-gradient(90deg, #4299e1 0%, #3182ce 100%);">kernel</span></span></div>
...
<div style="color: #e2e8f0; font-size: 13px; line-height: 1.6;">💡 <strong>核心洞察：</strong>NPU算子是异步下发的，CPU调用后立即返回，不等NPU算完。小矩阵时kernel执行极快，NPU算完的速度比CPU下发下一条命令还快，出现空闲等待。此时dispatch开销占主导，npu_linear的短路径优势明显。大矩阵时kernel执行时间更长，dispatch开销被完全"藏"在NPU执行时间里。</div>
</div>
...
<div style="background: linear-gradient(180deg, #f8fafc 0%, #edf2f7 100%); border: 1px solid #e2e8f0; border-radius: 18px; padding: 22px;">
<div style="font-size: 14px; font-weight: bold; color: #2d3748; margin-bottom: 8px; text-align: center;">优化阶段累计性能提升</div>
<div style="font-size: 12px; color: #718096; text-align: center; margin-bottom: 18px;">从原生实现到全 NPU 算子融合，性能收益持续累积，最终达到峰值配置。</div>
...
<div style="background: #fff5f5; border: 1px solid #fed7d7; border-radius: 14px; padding: 16px; text-align: center;"><div style="font-size: 12px; color: #e53e3e; font-weight: bold; margin-bottom: 6px;">初始基线</div><div style="font-size: 22px; color: #2d3748; font-weight: bold;">70.33 QPS</div><div style="font-size: 11px; color: #718096; margin-top: 4px;">原生实现，4线程</div></div>
<div style="background: #f0fff4; border: 1px solid #9ae6b4; border-radius: 14px; padding: 16px; text-align: center;"><div style="font-size: 12px; color: #2f855a; font-weight: bold; margin-bottom: 6px;">最终峰值</div><div style="font-size: 22px; color: #2d3748; font-weight: bold;">119.45 QPS</div><div style="font-size: 11px; color: #718096; margin-top: 4px;">全融合实现，4线程</div></div>
<div style="background: #ebf8ff; border: 1px solid #90cdf4; border-radius: 14px; padding: 16px; text-align: center;"><div style="font-size: 12px; color: #2b6cb0; font-weight: bold; margin-bottom: 6px;">净增收益</div><div style="font-size: 22px; color: #2d3748; font-weight: bold;">+49.12 QPS</div><div style="font-size: 11px; color: #718096; margin-top: 4px;">累计优化带来的绝对提升</div></div>
</div>
